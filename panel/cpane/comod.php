                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-plain">
                                ...
                                <form method="POST" action="comodsql.php">                                 
                                    <?php
                                    ...
                                    <div class="large-group">
                                        <div class="small-group">
                                            <label for="id">Código de comida a modificar</label>
                                        ...
                                        <div class="small-group">
                                            <label for="plati">Nombre del platillo</label>
                                            <input id="plati" type="text" name="plati"/>
                                        </div>
                                        
                                        <div class="small-group">
                                            <label for="tipoc">Tipo de comida</label>
                                            <input id="tipoc" type="text" name="tipoc"/>
                                        </div>
                                        ...
                                        <div class="small-group">
                                            <label for="acomp">Acompañamiento</label>
                                            <input id="acomp" type="text" name="acomp"/>
                                        </div>
                                        
                                        <div class="small-group">
                                            <label for="bebida">Bebida</label>
                                            <input id="bebida" type="text" name="bebida"/>
                                        </div>
                                        ...
                                        <div class="small-group">
                                            ...
                                            <input id="empr" type="text" name="empr"/>
                                        </div>
                                        ...
                                        <input id="submit" class="btn" type="submit" name="submit" value="Modificar"/>
                                    </div>
                                </form>
                            </div>
                        </div>
