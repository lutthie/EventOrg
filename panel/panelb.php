                ...
                <div class="content">
                    <div id="blublu">
                        <div id="success-box">
                            ...
                            <div class="message"><h1 class="alert">Bien echo!</h1><p id="pe">yay, se guardó tu cotización.</p></div>
                            <button class="button-box" onclick="location.href = 'panel.php'"><h1 class="green">Continuar</h1></button>
                        </div>
                    </div>
                </div>
            </div>
